...
import { Shield, Mail, Lock, User as UserIcon, LogIn, AlertCircle, CheckCircle } from 'lucide-react';
            ...
            <div className="relative z-10 w-full max-w-md px-6 animate-reveal">
                <Link to="/" className="flex justify-center mb-8">
                    <div className="flex items-center gap-3 group">
                        ...
                        <div>
                            ...
                            <p className="text-[8px] font-bold uppercase tracking-[0.3em] text-nv-yellow">Join the Pride</p>
                        </div>
                    </div>
                </Link>
                ...
                <div className="glass-strong rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 md:p-10 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.8)] border border-white/10 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-white/50 text-sm font-medium mb-8">Join the NVFC community</p>
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-white/60">
                                ...
                                <Link to="/login" className="text-nv-yellow font-bold hover:text-white transition-colors">
                                    Sign In
                                </Link>
                            </p>
                        </div>
